...
class Main
{
    public static void main(String[] args)
    {
        //TODO:
        // lav en ny hund
        Dog myDog = new Dog("woodie", true, true);
        // sæt en ejer
        ...
        // print alle hvalpe
        // Kunne ikke helt finde ud af det, så jeg lavede det i et arrayliste med for loop. :P
        myDog.getOffSpring();
        for (int i = 0; i < myDog.offSpring.size(); i++)
        {
            System.out.println(myDog.offSpring.get(i));
        }
        // print ejeren
