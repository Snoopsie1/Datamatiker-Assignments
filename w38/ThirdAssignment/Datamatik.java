...
class Datamatik
{
	...
	public static void main(String [] args)
	{
		...
		student1 = new Student("Oliver", 22, false, "Team E");
		student2 = new Student("Bjarke", 25, false, "Team E");

		System.out.println("One of our teachers is "+teacher1.name+"");
		System.out.println("I am "+student1.name+", and my co-student is "+student2.name+"");
		System.out.println("We are both from "+student1.datamatikerTeam+"");
